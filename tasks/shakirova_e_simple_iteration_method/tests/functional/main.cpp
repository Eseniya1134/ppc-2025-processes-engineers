...
TEST_P(ShakirovaESimpleIterationMethodFuncTests, MatmulFromPic) {
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<ShakirovaESimpleIterationMethodMPI, InType>(kTestParam, PPC_SETTINGS_example_processes_2),
                   ppc::util::AddFuncTask<ShakirovaESimpleIterationMethodSEQ, InType>(kTestParam, PPC_SETTINGS_example_processes_2));
...
INSTANTIATE_TEST_SUITE_P(PicMatrixTests, ShakirovaESimpleIterationMethodFuncTests, kGtestValues, kPerfTestName);
